...
const whiteList = ['404', 'login', 'user/login', 'user/register', 'user/registerResult', 'install/init'] // no redirect whitelist
      ...
      if (store.getters.addRouters.length === 0) {
        store.dispatch('GetUserInfo')
          ...
          .catch((e) => {
            ...
            if (e.code === httpResponseCode.UNAUTHORIZED || e.data.reload == true) {
