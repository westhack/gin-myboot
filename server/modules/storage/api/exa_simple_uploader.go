...
func (s *SimpleUploaderApi) SimpleUploaderUpload(c *gin.Context) {
	var chunk storage.ExaSimpleUploader
...
func (s *SimpleUploaderApi) CheckFileMd5(c *gin.Context) {
	...
	if err != nil {
		global.Logger.Error("md5读取失败!", zap.Any("err", err))
