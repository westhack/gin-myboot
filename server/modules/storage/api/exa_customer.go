...
import (
	...
	exampleRes "gin-myboot/modules/storage/model/response"
	"gin-myboot/utils"
...
// @Param data body storage.ExaCustomer true "客户用户名, 客户手机号码"
// @Success 200 {string} string "{"success":true,"data":{},"msg":"创建成功"}"
// @Router /customer/customer [post]
func (e *CustomerApi) CreateExaCustomer(c *gin.Context) {
	var customer storage.ExaCustomer
	...
	customer.SysUserRoleID = utils.GetUserRoleId(c)
...
// @accept application/json
// @Produce application/json
// @Param data body storage.ExaCustomer true "客户ID"
...
// @accept application/json
// @Produce application/json
// @Param data body storage.ExaCustomer true "客户ID, 客户信息"
...
// @accept application/json
// @Produce application/json
// @Param data query storage.ExaCustomer true "客户ID"
...
func (e *CustomerApi) GetExaCustomerList(c *gin.Context) {
	...
	err, customerList, total := customerService.GetCustomerInfoList(utils.GetUserRoleId(c), pageInfo)
	if err != nil {
		global.Logger.Error("获取失败!", zap.Any("err", err))
