...
type ExaCustomer struct {
	...
	SysUserID         uint64         `json:"sysUserId" form:"sysUserId" gorm:"comment:管理ID"`                  // 管理ID
	SysUserRoleID     uint64         `json:"sysUserRoleID" form:"sysUserRoleID" gorm:"comment:管理角色ID"`        // 管理角色ID
